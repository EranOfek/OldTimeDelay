function TimeSeries=simulate_lc_from_ps(Time,PowSpec,Errors)
...
% Example: % Generate a light curve with power-law power spectrum
%          % power-law of -2, Std of 1, and errors with StD of 0.1
%          TimeSeries=TimeDelay.simulate_lc_from_ps((0:1:100)',[2 1],randn(101,1).*0.1);
% Reliable: 2
%-----------------------------------------------------------------------------
