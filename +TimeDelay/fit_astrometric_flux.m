...
% Res=TimeDelay.fit_astrometric_flux(ResF.T, ResF.F_t,ResF.x_t,ResF.y_t,ResF.eps_F_abs,ResF.eps_x_abs,'VecInvTau',(1./70:0.5./256:1./15));
...
%addOptional(InPar,'FitPar',[NaN NaN NaN  0   1   -1   0   0   0    3]);  % [A0, A1, A2, x0, x1, x2, y0, y1, y2, gamma]
addOptional(InPar,'DefPar',[2 1   0.66  0   1   -1   0   0   0    3]);  % [A0, A1, A2, x0, x1, x2, y0, y1, y2, gamma]
addOptional(InPar,'Limits',[0 5;0 2;0 2;  -1 1; -2.1 2.1; -2.1 2.1;  -1 1; -2.1 2.1; -2.1 2.1;   1.5 3.5]); %  without Tau
...
addOptional(InPar,'VecInvTau',(2./100:0.5./100:1./10));
